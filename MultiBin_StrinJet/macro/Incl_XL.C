...
//=============================================================================
  ...
  for(int i=0; i<3; i++)h1[i] = PtSpectrum(1, i, 1, kFALSE, kFALSE); //Para1: "pp13TeV", "pp7TeV" 
...
//=============================================================================
  ...
  auto can(MakeCanvas("XLRatio_Incl"));
  //can->SetLogy();
  ...
  tex->DrawLatex(0.16, 0.7, "Inclusive #Xi/#Lambda");
