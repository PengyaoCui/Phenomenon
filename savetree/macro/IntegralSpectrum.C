...
void IntegralSpectrum(){
//=============================================================================
  
  TGraph* g[3];
  g[0] = InteSpectrum(1, 0, 0);    //Para1: "pp13TeV", "pp7TeV" 
  g[1] = InteSpectrum(1, 1, 0);    //Para2: "SoftQCD_CR", "SoftQCD_Rope", "SoftQCD_CRandRope"
  g[2] = InteSpectrum(1, 2, 0);    

//=============================================================================
  auto dflx(0.), dfux(30.);
  auto dfly(1e-1), dfuy(1e6);
  ...
  auto can(MakeCanvas("IntegralSpectra"));
  //can->SetLogy();
