...
\begin{figure}[ht]
	\begin{center}
		...
		\includegraphics[width=.49\textwidth]{Phi_PiRatio}	\includegraphics[width=.49\textwidth]{Kstar_PiRatio}
	\end{center}
...
\begin{sidewaystable}[!ht]
	\begin{center}
		\caption{Charge density in each event class $\dndeta_{{|\eta| < 0.5}}$.}
