...
void f6_InteRatio_XPi_JE(){
//=============================================================================
    auto hD(GetDataC("data/HEPData_1606.07424v2.root", 38)); 
    auto gD = GetDataE("data/HEPData_1606.07424v2.root", 38); 
    TGraph* g[3];
    g[0] = RatioToPi(1, 0, 2, kTRUE, kFALSE);    //Para1: "pp13TeV", "pp7TeV" 
    g[1] = RatioToPi(1, 1, 2, kTRUE, kFALSE);    //Para2: "SoftQCD_CR", "SoftQCD_Rope", "SoftQCD_CRandRope"
    g[2] = RatioToPi(1, 2, 2, kTRUE, kFALSE);    //Para3:"Kshort", "Lambda", "Xi", "Omega", "Phi", "Pion", "Kion", "Proton"
...
//  =============================================================================
    ...
    auto can(MakeCanvas("Xi_PiRatio_JE"));
    //can->SetLogy();
