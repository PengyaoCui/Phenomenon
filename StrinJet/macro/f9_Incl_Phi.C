...
//=============================================================================
    ...
    hD = GetDataC("data/HEPData_1910.14410.root", 4); 
    gD = GetDataE("data/HEPData_1910.14410.root", 4); 
    ...
    h1[0] = PtSpectrum(1, 0, 4, kFALSE, kFALSE);
...
//  =============================================================================
    ...
    auto can(MakeCanvas("Incl_PhiSpect"));
    can->SetLogy();
