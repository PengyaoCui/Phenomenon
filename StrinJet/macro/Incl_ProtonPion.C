...
//=============================================================================
  ...
  for(int i=0; i<3; i++)h1[i] = PtSpectrum(1, i, 5, kFALSE, kFALSE); //Para1: "pp13TeV", "pp7TeV" 
  for(int i=0; i<3; i++)h2[i] = PtSpectrum(1, i, 7, kFALSE, kFALSE); //Para2: "SoftQCD_CR", "SoftQCD_Rope", "SoftQCD_CRandRope"
...
//=============================================================================
  ...
  auto can(MakeCanvas("ProtonPionRatio_Incl"));
  //can->SetLogy();
