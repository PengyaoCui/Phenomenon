...
//=============================================================================
  ...
  for(int i=0; i<3; i++)h1[i] = PartoJet(1, i, 1); //Para1: "pp13TeV", "pp7TeV" 
  for(int i=0; i<3; i++)h2[i] = PartoJet(1, i, 2); //Para2: "SoftQCD_CR", "SoftQCD_Rope", "SoftQCD_CRandRope"
...
//=============================================================================
  ...
  auto can(MakeCanvas("XL_toJetRange"));
  //can->SetLogy();
