...
//=============================================================================
    ...
    for(int i=0; i<10; i++){
      hD[i] = GetDataC("data/HEPData_1910.14397v1.root", 1+i); 
      gD[i] = (TGraphErrors*)GetDataE("data/HEPData_1910.14397v1.root", 1+i); 
      h1[i] = PtSpectrum(1, 0, 8, dCent[i], dCent[i+1], kFALSE, kFALSE); //Para1: "pp13TeV", "pp7TeV"
...
//  =============================================================================
    ...
    auto can(MakeCanvas("Incl_KstarSpect"));
    can->SetLogy();
    ...
    leg->AddEntry(g[i], Form("%.1f-%.1f%%", dCent[i], dCent[i+1]),  "L")->SetTextSizePixels(24);
    }
