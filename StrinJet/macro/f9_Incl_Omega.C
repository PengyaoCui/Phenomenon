...
//=============================================================================
    ...
    hD = GetDataC("data/HEPData_1204.0292v3.root", 1); 
    gD = GetDataE("data/HEPData_1204.0292v3.root", 1); 
    //Para1: "pp13TeV", "pp7TeV"
    //Para2: "SoftQCD_CR", "SoftQCD_Rope", "SoftQCD_CRandRope"
    //Para3:"Kshort", "Lambda", "Omega", "Omega", "Phi", "Pion", "Kion", "Proton"
    //Para6: jet cone: kTRUE, kFALSE
    //Para7: PC: kTRUE, kFALSE
    h1[0] = PtSpectrum(1, 0, 3, kFALSE, kFALSE);
    h1[1] = PtSpectrum(1, 1, 3, kFALSE, kFALSE); 
    h1[2] = PtSpectrum(1, 2, 3, kFALSE, kFALSE); 
    for(int i = 0; i<3; i++){
     //h1[i]->Scale(1./(0.75*2));
      g[i] = new TGraph(h1[i]);
    }
//  =============================================================================
    ...
    auto can(MakeCanvas("Incl_OmegaSpect"));
    can->SetLogy();
