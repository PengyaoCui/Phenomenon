...
//=============================================================================
    ...
    hD = GetDataC("data/HEPData_2005.11120.root", 11); 
    gD = GetDataE("data/HEPData_2005.11120.root", 11); 
    ...
    h1[0] = PtSpectrum(1, 0, 1, kFALSE, kFALSE);
    h1[1] = PtSpectrum(1, 1, 1, kFALSE, kFALSE); 
    h1[2] = PtSpectrum(1, 2, 1, kFALSE, kFALSE); 
    for(int i = 0; i<3; i++){
      //h1[i]->Scale(1./(0.75));
      g[i] = new TGraph(h1[i]);
    }
//  =============================================================================
    ...
    TString sPar("#Lambda + #bar{#Lambda}");
    
    SetStyle(kTRUE);
    gStyle->SetErrorX(0);
    
    auto can(MakeCanvas("Incl_LambdaSpect"));
    can->SetLogy();
