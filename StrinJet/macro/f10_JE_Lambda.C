...
//=============================================================================
    ...
    h1[0] = PtSpectrum(1, 0, 1, kTRUE, kFALSE);
    h1[1] = PtSpectrum(1, 1, 1, kTRUE, kFALSE); 
    h1[2] = PtSpectrum(1, 2, 1, kTRUE, kFALSE); 
    for(int i = 0; i<3; i++){
...
//  =============================================================================
    ...
    auto can(MakeCanvas("JE_LambdaSpect"));
    can->SetLogy();
    ...
    tex->DrawLatex(0.16, 0.8, Form("%s + #bar{#Lambda} in jets spectra", sPar.Data()));
