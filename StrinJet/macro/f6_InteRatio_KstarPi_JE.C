...
void f6_InteRatio_KstarPi_JE(){
//=============================================================================
    //auto hD(GetDataC("data/HEPData_1807.11321v2.root", 97)); 
    //auto gD = GetDataE("data/HEPData_1807.11321v2.root", 97); 
    TGraph* g[3];
    g[0] = RatioToPi(1, 0, 8, kTRUE, kFALSE);    //Para1: "pp13TeV", "pp7TeV" 
    g[1] = RatioToPi(1, 1, 8, kTRUE, kFALSE);    //Para2: "SoftQCD_CR", "SoftQCD_Rope", "SoftQCD_CRandRope"
    g[2] = RatioToPi(1, 2, 8, kTRUE, kFALSE);    //Para3:"Kshort", "Lambda", "Xi", "Omega", "Phi", "Pion", "Kion", "Proton"
...
//  =============================================================================
    ...
    auto can(MakeCanvas("Kstar_PiRatio_JE"));
    //can->SetLogy();
