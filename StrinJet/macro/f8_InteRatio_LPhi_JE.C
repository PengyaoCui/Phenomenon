...
void f8_InteRatio_LPhi_JE(){
//=============================================================================
  //auto hD(GetDataC("data/HEPData.root", 36+i)); 
  //auto gD = GetDataE("data/HEPData.root", 36+i); 
  TGraph* g[3];
  g[0] = InteRatio(1, 0, 1, 4, kTRUE, kFALSE); //Para1: "pp13TeV", "pp7TeV" 
  g[1] = InteRatio(1, 1, 1, 4, kTRUE, kFALSE); //Para2: "SoftQCD_CR", "SoftQCD_Rope", "SoftQCD_CRandRope"
  g[2] = InteRatio(1, 2, 1, 4, kTRUE, kFALSE); //Para3:numarator:"Kshort", "Lambda", "Xi", "Omega", "Phi", "Pion", "Kion", "Proton"
...
//=============================================================================
  ...
  TString stny("#Lambda/#phi");
  
  SetStyle(kTRUE);
  gStyle->SetErrorX(0);
  
  auto can(MakeCanvas("Inte_LambdaPhiRatio_JE"));
  //can->SetLogy();
