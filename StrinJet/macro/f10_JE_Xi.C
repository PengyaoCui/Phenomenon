...
//=============================================================================
    ...
    h1[0] = PtSpectrum(1, 0, 2, kTRUE, kFALSE);
    h1[1] = PtSpectrum(1, 1, 2, kTRUE, kFALSE); 
    h1[2] = PtSpectrum(1, 2, 2, kTRUE, kFALSE); 
    for(int i = 0; i<3; i++){
...
//  =============================================================================
    ...
    auto can(MakeCanvas("JE_XiSpect"));
    can->SetLogy();
    ...
    tex->DrawLatex(0.16, 0.8, Form("%s^{-} + #bar{#Xi}^{+} in JE spectra", sPar.Data()));
