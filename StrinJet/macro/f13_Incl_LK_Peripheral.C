...
void f13_Incl_LK_Peripheral(){
//=============================================================================
  auto hD(GetDataC("data/HEPData_1807.11321v2.root", 78)); 
  auto gD(GetDataE("data/HEPData_1807.11321v2.root", 78)); 
  ...
  for(int i=0; i<3; i++)h1[i] = PtSpectrum(1, i, 0, dCent[nc-2], dCent[nc-1], kFALSE, kFALSE);
  for(int i=0; i<3; i++)h2[i] = PtSpectrum(1, i, 1, dCent[nc-2], dCent[nc-1], kFALSE, kFALSE);
...
//=============================================================================
  ...
  auto can(MakeCanvas("LKRatio_Incl_Peripheral"));
  //can->SetLogy();
  can->SetLogx();
  ...
  tex->DrawLatex(0.16, 0.8, Form("Cent: %.0f-%.0f%%", dCent[nc-2], dCent[nc-1]));
