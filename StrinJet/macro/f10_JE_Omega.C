...
//=============================================================================
    ...
    h1[0] = PtSpectrum(1, 0, 3, kTRUE, kFALSE);
    h1[1] = PtSpectrum(1, 1, 3, kTRUE, kFALSE); 
    h1[2] = PtSpectrum(1, 2, 3, kTRUE, kFALSE); 
    for(int i = 0; i<3; i++){
...
//  =============================================================================
    ...
    auto can(MakeCanvas("JE_OmegaSpect"));
    can->SetLogy();
    ...
    tex->DrawLatex(0.16, 0.8, Form("%s^{-} + #bar{#Omega}^{+} in JE spectra", sPar.Data()));
