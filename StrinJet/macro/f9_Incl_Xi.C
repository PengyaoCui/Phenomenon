...
//=============================================================================
    ...
    hD = GetDataC("data/HEPData_1204.0292v3.root", 2); 
    gD = GetDataE("data/HEPData_1204.0292v3.root", 2); 
    ...
    h1[0] = PtSpectrum(1, 0, 2, kFALSE, kFALSE);
    h1[1] = PtSpectrum(1, 1, 2, kFALSE, kFALSE); 
    h1[2] = PtSpectrum(1, 2, 2, kFALSE, kFALSE); 
    for(int i = 0; i<3; i++){
      //h1[i]->Scale(1./(0.75*2));
      g[i] = new TGraph(h1[i]);
    }
//  =============================================================================
    ...
    auto can(MakeCanvas("Incl_XiSpect"));
    can->SetLogy();
