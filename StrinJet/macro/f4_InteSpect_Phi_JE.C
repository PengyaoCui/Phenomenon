...
//=============================================================================
  ...
  //leg->AddEntry(hD, "Data(13 TeV Incl)",  "P")->SetTextSizePixels(24);
  ...
  tex->DrawLatex(0.16, 0.8, Form("Integrated yield of #phi in jet"));
