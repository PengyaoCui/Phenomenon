...
//=============================================================================
    ...
    TGraph* g[3];
    g[0] = RatioToPi(1, 0, 2);    //Para1: "pp13TeV", "pp7TeV" 
    g[1] = RatioToPi(1, 1, 2);    //Para2: "SoftQCD_CR", "SoftQCD_Rope", "SoftQCD_CRandRope"
    g[2] = RatioToPi(1, 2, 2);    //Para3:"Kshort", "Lambda", "Xi", "Omega", "Phi", "Pion", "Kion", "Proton"
