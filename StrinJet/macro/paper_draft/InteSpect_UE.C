...
//=============================================================================
  ...
  g[0][p] = InteSpectrum(1, 0, p, kFALSE, kTRUE, 4);g[0][0]->SetName((sp[p] + sm[0]).Data());//Para1: "pp13TeV", "pp7TeV" 
  g[1][p] = InteSpectrum(1, 1, p, kFALSE, kTRUE, 4);g[1][0]->SetName((sp[p] + sm[1]).Data());//Para2: "SoftQCD_CR", "SoftQCD_Rope", "SoftQCD_CRandRope"
  g[2][p] = InteSpectrum(1, 2, p, kFALSE, kTRUE, 4);g[2][0]->SetName((sp[p] + sm[2]).Data());
                                              
  p = 5;//Kstar                               
  g[0][p] = InteSpectrum(1, 0, 8, kFALSE, kTRUE, 6);g[0][0]->SetName((sp[8] + sm[0]).Data());
  g[1][p] = InteSpectrum(1, 1, 8, kFALSE, kTRUE, 6);g[1][0]->SetName((sp[8] + sm[1]).Data());
  g[2][p] = InteSpectrum(1, 2, 8, kFALSE, kTRUE, 6);g[2][0]->SetName((sp[8] + sm[2]).Data());
                                              
                                              
  p = 4;//Phi                                 
  g[0][p] = InteSpectrum(1, 0, p, kFALSE, kTRUE, 12);g[0][0]->SetName((sp[p] + sm[0]).Data());
  g[1][p] = InteSpectrum(1, 1, p, kFALSE, kTRUE, 12);g[1][0]->SetName((sp[p] + sm[1]).Data());
  g[2][p] = InteSpectrum(1, 2, p, kFALSE, kTRUE, 12);g[2][0]->SetName((sp[p] + sm[2]).Data());
                                              
  p = 1;//Lambda                              
  g[0][p] = InteSpectrum(1, 0, p, kFALSE, kTRUE, 1);g[0][0]->SetName((sp[p] + sm[0]).Data());
  g[1][p] = InteSpectrum(1, 1, p, kFALSE, kTRUE, 1);g[1][0]->SetName((sp[p] + sm[1]).Data());
  g[2][p] = InteSpectrum(1, 2, p, kFALSE, kTRUE, 1);g[2][0]->SetName((sp[p] + sm[2]).Data());
                                              
  p = 2;//Xi                                  
  g[0][p] = InteSpectrum(1, 0, p, kFALSE, kTRUE, 2);g[0][0]->SetName((sp[p] + sm[0]).Data());
  g[1][p] = InteSpectrum(1, 1, p, kFALSE, kTRUE, 2);g[1][0]->SetName((sp[p] + sm[1]).Data());
  g[2][p] = InteSpectrum(1, 2, p, kFALSE, kTRUE, 2);g[2][0]->SetName((sp[p] + sm[2]).Data());
