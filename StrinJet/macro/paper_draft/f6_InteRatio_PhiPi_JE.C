...
void f6_InteRatio_PhiPi_JE(){
//=============================================================================
    //auto hD(GetDataC("data/HEPData_1606.07424v2.root", 36)); 
    //auto gD = GetDataE("data/HEPData_1606.07424v2.root", 36); 
    TGraph* g[3];
    g[0] = RatioToPi(1, 0, 4, kTRUE, kFALSE);    //Para1: "pp13TeV", "pp7TeV" 
    g[1] = RatioToPi(1, 1, 4, kTRUE, kFALSE);    //Para2: "SoftQCD_CR", "SoftQCD_Rope", "SoftQCD_CRandRope"
    g[2] = RatioToPi(1, 2, 4, kTRUE, kFALSE);    //Para3:"Kshort", "Lambda", "Xi", "Omega", "Phi", "Pion", "Kion", "Proton"

//  =============================================================================
    //auto y = (Double_t)hD->GetMaximum();
    auto dflx(0.), dfux(30.);
    auto dfly(0.), dfuy(0.018);
    ...
    auto can(MakeCanvas("Phi_PiRatio_JE"));
    //can->SetLogy();
