...
//=============================================================================
  ...
  h1[0] = PtSpectrum(1, 1, 0, dCent[0], dCent[1], kFALSE, kFALSE); //Para1: "pp13TeV", "pp7TeV" 
  h2[0] = PtSpectrum(1, 1, 1, dCent[0], dCent[1], kFALSE, kFALSE); //Para2: "SoftQCD_CR", "SoftQCD_Rope", "SoftQCD_CRandRope"
  h1[1] = PtSpectrum(1, 1, 0, dCent[nc-2], dCent[nc-1], kFALSE, kFALSE); //Para3:"Kshort", "Lambda", "Xi", "Omega", "Phi", "Pion", "Kion", "Proton"
  h2[1] = PtSpectrum(1, 1, 1, dCent[nc-2], dCent[nc-1], kFALSE, kFALSE); //Para4:Centmin 
                                                                   //Para5:Centmax 
...
//=============================================================================
  ...
  auto can(MakeCanvas("LKRatio_Incl_Cent_Data_rope"));
  can->SetLogx();
  ...
  leg->AddEntry(hD[0], Form("%.0f-%.2f%%(20)", dCent[0], dCent[1]), "L")->SetTextSizePixels(24);
