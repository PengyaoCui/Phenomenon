...
void f7_InteRatio_OPhi(){
//=============================================================================
  //auto hD(GetDataC("data/HEPData.root", 36+i)); 
  //auto gD = GetDataE("data/HEPData.root", 36+i); 
  TGraph* g[3];
  g[0] = InteRatio(1, 0, 3, 4);    //Para1: "pp13TeV", "pp7TeV" 
  g[1] = InteRatio(1, 1, 3, 4);    //Para2: "SoftQCD_CR", "SoftQCD_Rope", "SoftQCD_CRandRope"
  g[2] = InteRatio(1, 2, 3, 4);    //Para3:Nulmerator "Kshort", "Lambda", "Xi", "Omega", "Phi", "Pion", "Kion", "Proton"
                                   //Para4:Denomenator "Kshort", "Lambda", "Xi", "Omega", "Phi", "Pion", "Kion", "Proton"
//=============================================================================
  //auto y = (Double_t)hD->GetMaximum();
  auto dflx(0.), dfux(25.);
  auto dfly(0.0), dfuy(0.065);
  ...
  auto can(MakeCanvas("Inte_OmegaPhiRatio"));
  //can->SetLogy();
