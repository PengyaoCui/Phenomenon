...
//=============================================================================
    ...
    hD = GetDataC("data/HEPData_1910.14410.root", 3); 
    gD = GetDataE("data/HEPData_1910.14410.root", 3); 
    ...
    h1[0] = PtSpectrum(1, 0, 8, kFALSE, kFALSE);
    h1[1] = PtSpectrum(1, 1, 8, kFALSE, kFALSE); 
    h1[2] = PtSpectrum(1, 2, 8, kFALSE, kFALSE); 
    for(int i = 0; i<3; i++){
      //h1[i]->Scale(1./(0.75*2));
      g[i] = new TGraph(h1[i]);
    }
