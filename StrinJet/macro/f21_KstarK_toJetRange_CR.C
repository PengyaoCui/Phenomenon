...
//=============================================================================
 ...
 //Para5: centmax
  ...
  for(int i=0; i<n; i++)h1[i] = PartoJet(1, 0, 0, c[i], c[i+1]);
  for(int i=0; i<n; i++)h2[i] = PartoJet(1, 0, 8, c[i], c[i+1]);
...
//=============================================================================
  ...
  auto can(MakeCanvas("KstarK_toJetRange_cent_CR"));
  //can->SetLogy();
