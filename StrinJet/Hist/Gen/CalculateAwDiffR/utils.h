...
const TString gksStrgs[] = {"Kshort", "Lambda", "Xi", "Omega", "Phi", "Kstar", "Pion", "Kion", "Proton"};
enum struct EStrg : unsigned int {  Kshort=0, Lambda, Xi, Omega, Phi, Kstar, Pion, Kion, Proton, Undef };
