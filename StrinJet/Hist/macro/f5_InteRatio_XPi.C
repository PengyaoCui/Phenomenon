...
void f5_InteRatio_XPi(){
//=============================================================================
    auto hD(GetDataC("data/HEPData_1606.07424v2.root", 38)); 
    auto gD = GetDataE("data/HEPData_1606.07424v2.root", 38); 
    TGraph* g[3];
    g[0] = RatioToPi(1, 0, 2, kFALSE, kFALSE, 0.5);    //Para1: "pp13TeV", "pp7TeV" 
    g[1] = RatioToPi(1, 1, 2, kFALSE, kFALSE, 0.5);    //Para2: "SoftQCD_CR", "SoftQCD_Rope", "SoftQCD_CRandRope"
    g[2] = RatioToPi(1, 2, 2, kFALSE, kFALSE, 0.5);    //Para3:"Kshort", "Lambda", "Xi", "Omega", "Phi", "Pion", "Kion", "Proton"

//  =============================================================================
    auto y = (Double_t)hD->GetMaximum();
    auto dflx(0.), dfux(25.);
    auto dfly(0.0005), dfuy(0.009);
    ...
    auto can(MakeCanvas("Xi_PiRatio"));
    //can->SetLogy();
