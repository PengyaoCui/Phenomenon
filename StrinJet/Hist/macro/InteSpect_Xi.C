...
void InteSpect_Xi(){
//=============================================================================
  auto hD(GetDataC("data/HEPData_1606.07424v2.root", 44)); 
  auto gD = GetDataE("data/HEPData_1606.07424v2.root", 44); 

  int p = 2;//{0="Kshort", "Lambda", "Xi", "Omega", "Phi", "Kstar", "Pion", "Kion", "Proton"};
  TGraphErrors* h[4];
  h[0] = InteSpectrum("Monash",  p, kFALSE, kFALSE, 2);//Para1: "Monash", "CR", "Rope", "CR+Rope" 
  h[1] = InteSpectrum("CR",      p, kFALSE, kFALSE, 2);//Para2: particle 
  h[2] = InteSpectrum("Rope",    p, kFALSE, kFALSE, 2);//Para3: Is JE? 
  h[3] = InteSpectrum("CR+Rope", p, kFALSE, kFALSE, 2);//Para4: Is UE?
                                                      //Para5: scale
