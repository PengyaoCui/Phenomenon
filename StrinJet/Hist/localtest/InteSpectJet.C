...
//=============================================================================
  ...
  auto list(static_cast<TList*>(file->Get("Monash")));
  auto h((TH1D*)list->FindObject(Form("hJetKshort")));
...
//=============================================================================
  ...
  TString stny("#it{N}_{jet}/#it{N}_{ev}");
 
  SetStyle(kTRUE);
  gStyle->SetErrorX(0);
  
  auto can(MakeCanvas(Form("JetInteSpectrum")));
  //can->SetLogy();
