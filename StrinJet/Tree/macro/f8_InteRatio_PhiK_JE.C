...
void f8_InteRatio_PhiK_JE(){
//=============================================================================
  auto hD(GetDataC("data/HEPData_1910.14397v1.root", 44)); 
  auto gD = GetDataE("data/HEPData_1910.14397v1.root", 44); 
  TGraph* g[3];
  g[0] = InteRatio(1, 0, 4, 0, kTRUE, kFALSE); //Para1: "pp13TeV", "pp7TeV" 
  g[1] = InteRatio(1, 1, 4, 0, kTRUE, kFALSE); //Para2: "SoftQCD_CR", "SoftQCD_Rope", "SoftQCD_CRandRope"
  g[2] = InteRatio(1, 2, 4, 0, kTRUE, kFALSE); //Para3:numarator:"Kshort", "Lambda", "Xi", "Omega", "Phi", "Pion", "Kion", "Proton"
...
//=============================================================================
  ...
  auto can(MakeCanvas("Inte_PhiKRatio_JE"));
  //can->SetLogy();
