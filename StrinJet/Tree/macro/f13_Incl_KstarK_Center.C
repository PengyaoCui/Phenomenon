...
void f13_Incl_KstarK_Center(){
//=============================================================================
  auto hD(GetDataC("data/HEPData_1910.14397v1.root", 47)); 
  auto gD = GetDataE("data/HEPData_1910.14397v1.root", 47); 
  ...
  for(int i=0; i<3; i++)h2[i] = PtSpectrum(1, i, 8, dCent[1], dCent[2], kFALSE, kFALSE);
...
//=============================================================================
  ...
  auto can(MakeCanvas("KstarKRatio_Incl_Center"));
  //can->SetLogy();
  //can->SetLogx();
