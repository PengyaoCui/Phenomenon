...
void f8_InteRatio_KstarK_JE(){
//=============================================================================
  auto hD(GetDataC("data/HEPData_1910.14397v1.root", 43)); 
  auto gD = GetDataE("data/HEPData_1910.14397v1.root", 43); 
  TGraph* g[3];
  g[0] = InteRatio(1, 0, 8, 0, kTRUE, kFALSE); //Para1: "pp13TeV", "pp7TeV" 
  g[1] = InteRatio(1, 1, 8, 0, kTRUE, kFALSE); //Para2: "SoftQCD_CR", "SoftQCD_Rope", "SoftQCD_CRandRope"
  g[2] = InteRatio(1, 2, 8, 0, kTRUE, kFALSE); //Para3:numarator:"Kshort", "Lambda", "Xi", "Omega", "Phi", "Pion", "Kion", "Proton"
                                               //Para3:denomenator:"Kshort", "Lambda", "Xi", "Omega", "Phi", "Pion", "Kion", "Proton"
//=============================================================================
  ...
  TString stny("K*^{0}/K^{0}_{S}");
  
  SetStyle(kTRUE);
  gStyle->SetErrorX(0);
  
  auto can(MakeCanvas("Inte_KstarKRatio_JE"));
  //can->SetLogy();
