...
void f13_Incl_KstarK_Peripheral(){
//=============================================================================
  auto hD(GetDataC("data/HEPData_1910.14397v1.root", 48)); 
  auto gD = GetDataE("data/HEPData_1910.14397v1.root", 48); 
  ...
  for(int i=0; i<3; i++)h1[i] = PtSpectrum(1, i, 0, dCent[9], dCent[10], kFALSE, kFALSE);
  for(int i=0; i<3; i++)h2[i] = PtSpectrum(1, i, 8, dCent[9], dCent[10], kFALSE, kFALSE);
...
//=============================================================================
  ...
  auto can(MakeCanvas("KstarKRatio_Incl_Peripheral"));
  //can->SetLogy();
  //can->SetLogx();
  ...
  tex->DrawLatex(0.16, 0.8, Form("Cent: %.0f-%.0f%%", dCent[9], dCent[10]));
