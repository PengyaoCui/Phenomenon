...
void f13_Incl_PhiK_Peripheral(){
//=============================================================================
  auto hD(GetDataC("data/HEPData_1910.14397v1.root", 50)); 
  auto gD = GetDataE("data/HEPData_1910.14397v1.root", 50); 
  ...
  for(int i=0; i<3; i++)h2[i] = PtSpectrum(1, i, 4, dCent[9], dCent[10], kFALSE, kFALSE);
...
//=============================================================================
  ...
  auto can(MakeCanvas("PhiKRatio_Incl_Peripheral"));
  //can->SetLogy();
  //can->SetLogx();
