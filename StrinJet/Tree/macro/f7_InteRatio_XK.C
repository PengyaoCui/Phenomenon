...
void f7_InteRatio_XK(){
//=============================================================================
  //auto hD(GetDataC("data/HEPData.root", 36+i)); 
  //auto gD = GetDataE("data/HEPData.root", 36+i); 
  TGraph* g[3];
  g[0] = InteRatio(1, 0, 2, 0);    //Para1: "pp13TeV", "pp7TeV" 
  g[1] = InteRatio(1, 1, 2, 0);    //Para2: "SoftQCD_CR", "SoftQCD_Rope", "SoftQCD_CRandRope"
  g[2] = InteRatio(1, 2, 2, 0);    //Para3:Nulmerator "Kshort", "Lambda", "Xi", "Omega", "Phi", "Pion", "Kion", "Proton"
...
//=============================================================================
  ...
  auto can(MakeCanvas("Inte_XiKshortRatio"));
  //can->SetLogy();
