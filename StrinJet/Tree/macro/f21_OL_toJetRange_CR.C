...
//=============================================================================
 ...
 //Para5: centmax
  ...
  for(int i=0; i<n; i++)h1[i] = PartoJet(1, 0, 1, c[i], c[i+1]);
  for(int i=0; i<n; i++)h2[i] = PartoJet(1, 0, 3, c[i], c[i+1]);
...
//=============================================================================
  ...
  auto can(MakeCanvas("OL_toJetRange_cent_CR"));
  //can->SetLogy();
