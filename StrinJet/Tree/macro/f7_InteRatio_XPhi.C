...
void f7_InteRatio_XPhi(){
//=============================================================================
  auto hD(GetDataC("data/HEPData_1910.14397v1.root", 45)); 
  auto gD = GetDataE("data/HEPData_1910.14397v1.root", 45); 
  TGraph* g[3];
  g[0] = InteRatio(1, 0, 2, 4);    //Para1: "pp13TeV", "pp7TeV" 
  g[1] = InteRatio(1, 1, 2, 4);    //Para2: "SoftQCD_CR", "SoftQCD_Rope", "SoftQCD_CRandRope"
  g[2] = InteRatio(1, 2, 2, 4);    //Para3:Nulmerator "Kshort", "Lambda", "Xi", "Omega", "Phi", "Pion", "Kion", "Proton"
                                   //Para4:Denomenator "Kshort", "Lambda", "Xi", "Omega", "Phi", "Pion", "Kion", "Proton"
//=============================================================================
  auto y = (Double_t)hD->GetMaximum();
  auto dflx(0.), dfux(25.);
  auto dfly(0.1), dfuy(2.*y);
  ...
  auto can(MakeCanvas("Inte_XiPhiRatio"));
  //can->SetLogy();
