...
void f23_KstarK_toJetRange_Rope(){
//=============================================================================
...
//=============================================================================
 ...
 //Para5: centmax
  ...
  for(int i=0; i<n; i++)h1[i] = PartoJet(1, 1, 0, c[i], c[i+1]);
  for(int i=0; i<n; i++)h2[i] = PartoJet(1, 1, 8, c[i], c[i+1]);
...
//=============================================================================
  ...
  auto can(MakeCanvas("KstarK_toJetRange_cent_Rope"));
  //can->SetLogy();
