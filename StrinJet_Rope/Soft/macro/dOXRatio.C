...
//=============================================================================
  ...
  can->SaveAs(Form("./figure/eps/OXRatio_sQCD_CR_rope.eps"));
  can->SaveAs(Form("./figure/pdf/OXRatio_sQCD_CR_rope.pdf"));
  can->SaveAs(Form("./figure/png/OXRatio_sQCD_CR_rope.png"));
  CanvasEnd(can);
